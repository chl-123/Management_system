...
<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
    ...
    <form action="http://localhost:8081/Management_System/admin/do/login/page.html" method="post">
        <P style="padding: 30px 0px 10px; position: relative;">
            <SPAN class="u_logo"></SPAN>
            <INPUT name="loginAccount" class="ipt" type="text" placeholder="请输入用户名或邮箱" value="">
        </P>
        <P style="position: relative;">
            <SPAN class="p_logo"></SPAN>
            <INPUT name="loginPassword" class="ipt" id="password" type="password" placeholder="请输入密码" value="">
        </P>
